...
class DataSet:
    ...
    def __init__(self):
        ...
        ## variables for reading raw data
    ...
    def read_raw_data(self, userMin, itemMin, userSample =15_000, itemSample = 6_000):
        ...
        for i, j in zip (df_nan ['index'] [1:], df_nan ['index'] [:-1]):
            movie_id += 1
            if movie_id == 1:
                movie_np [j:i] = movie_id
            else:
                k = i - movie_id - 1
                l = j - movie_id + 2
                movie_np [l:k] = movie_id
        ...
        #nx_U0_I0_minU10_minI10

        np.savetxt(self.save_path + "nx_U" + str(userSample)+"_U"+ str(itemSample) +"_minU" + str(userMin) + "_minI" +
    ...
    def loadClicks(self, userMin, itemMin, userSample =15_000, itemSample = 6_000):
        try:
            df = pd.read_csv (self.save_path + "nx_U" + str(userSample)+"_U"+ str(itemSample) +"_minU" +
